...
menu = {}
menu['(1)']="Auto PROFILE.	(10) Auto Processes.	(19) Auto HIVES.	(28) Malfind PID.		(37)"
menu['(2)']="Set PROFILE.	(11) List Processes.	(20) View SAM.		(29) Mutant PID.		(38)"
menu['(3)']="Set PID.		(12) List Services.	(21) View SECURITY.	(30) Vaddump PID.		(39)"
menu['(4)']="Set PPID.		(13) Build Timeline.	(22) View SOFTWARE.	(31) Memory Dump PID.		(40)"
menu['(5)']="Set PARAMETER.	(14) Extract Files. 	(23) View COMPONENT.	(32) 				(41)"
menu['(6)']="Search PARAMETER.	(15) Dump Screenshots.	(24) View SYSTEM.	(33) Show Clipboard.		(42)"
menu['(7)']="			(16) 			(25) Dump MFT table.	(34) Show UserAssist Keys.	(43)"
menu['(8)']="			(17) 			(26) 			(35) Show Console.		(44)"
menu['(9)']="Clean and Exit.	(18)			(27)			(36)				(45)"
...
# -------------------------------------------------------------------------------------
   ...
   if selection =='1':
      print "Finding the appropriate image profile..."
...
# -------------------------------------------------------------------------------------
   ...
   if selection =='9':
      ...
      if os.path.exists('screenShots'):
         os.system('cd screenShots; rm *.*; cd ..')
         os.rmdir('screenShots')
      if os.path.exists('mft_table.txt'):
         os.remove('mft_table.txt')
      exit(0)
...
# CONTRACT: GitHub
# Version : 1.0
# Details : Menu option selected - Dump MFT table.
# Modified: N/A
# -------------------------------------------------------------------------------------

   if selection =='25':
      print "Exporting MFT table to mft_table.txt"
      os.system("volatility -f " + fileName + PRO + " mftparser >> mft_table.txt")
#      selection=raw_input("\nPlease any key to continue...")
...
# -------------------------------------------------------------------------------------
   ...
   if selection =='28':
      os.system("volatility -f " + fileName + PRO + " malfind -p " + PID + " --dump-dir screenShots")
      selection=raw_input("\nPlease any key to continue...")
...
# -------------------------------------------------------------------------------------
   ...
   if selection =='30':
      os.system("volatility -f " + fileName + PRO + " vaddump -p " + PID + " -D screenShots")
      selection=raw_input("\nPlease any key to continue...")
...
# -------------------------------------------------------------------------------------
   ...
   if selection =='31':
      os.system("volatility -f " + fileName + PRO + " memdump -p " + PID + " -D screenShots")
      selection=raw_input("\nPlease any key to continue...")
