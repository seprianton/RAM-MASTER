...
# -------------------------------------------------------------------------------------
   ...
   print colored("\t\t\t __  __ _____ __  __  ___  ______   __  __  __    _    ____ _____ _____ ____   ",'red')
   print colored("\t\t\t|  \/  | ____|  \/  |/ _ \|  _ \ \ / / |  \/  |  / \  / ___|_   _| ____|  _ \  ",'red')
   print colored("\t\t\t| |\/| |  _| | |\/| | | | | |_) \ V /  | |\/| | / _ \ \___ \ | | |  _| | |_) | ",'red')
   print colored("\t\t\t| |  | | |___| |  | | |_| |  _ < | |   | |  | |/ ___ \ ___) || | | |___|  _ <  ",'red')
   print colored("\t\t\t|_|  |_|_____|_|  |_|\___/|_| \_\|_|   |_|  |_/_/   \_\____/ |_| |_____|_| \_\ " ,'red')
   print colored("                                                                                     ",'red')
...
# -------------------------------------------------------------------------------------
   ...
   print " "*14,
   print colored("IDENTIFY",'red'),
   print " "*15,
   print colored("ANALYSE",'red'),
   print " "*17,
   print colored("INVESTIGATE",'red'),
   print " "*18,
   print colored("EXTRACT",'red'),
   print " "*10
   print "*"*134
